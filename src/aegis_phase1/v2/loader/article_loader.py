...
DOMAIN_ARTICLES: dict[str, dict[str, list[str]]] = {
    ...
    "D-02": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-03": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-04": {
        "GDPR": ["Art. 33", "Art. 34"],
        "CRA": ["Art. 14"],
        "NIS2": [],
    ...
    "D-05": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-06": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-07": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-08": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
    "D-09": {"GDPR": [], "CRA": [], "NIS2": [], "DORA": [], "AI_Act": []},
}
