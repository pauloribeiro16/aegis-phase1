...
phase: 1
version: 1.0
created: "2026-09-01T14:33:22Z"
updated: "2026-09-01T14:33:22Z"
author: Executor
status: DRAFT
case_study: UNKNOWN
...
generated_at: "2026-09-01T14:33:22Z"
---
...
The matrix below contains one row per sub-domain (38 nominal). Each covered cell carries a check mark and regulation abbreviation when that regulation has at least one clause mapping onto the sub-domain, or "—" when not applicable. NI (normative intensity) is the mean of the ``normative_strength`` field across all clauses that map onto the cell, rounded to one decimal.

| Sub-domain | Name | CRA | GDPR | Total | Status | NI |
| --- | --- | --- | --- | --- | --- | --- |
| D-01.1 | D-01.1 Data at Rest Encryption | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-01.2 | D-01.2 Data in Transit Encryption | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-01.3 | D-01.3 Cryptographic Key Management | — | ✅ GDPR | 1 | PARTIAL | 2.0 |
| D-01.4 | D-01.4 Data Integrity Mechanisms | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-02.1 | D-02.1 Vulnerability Identification | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-02.2 | D-02.2 Patch Management & Updates | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-02.3 | D-02.3 Coordinated Vulnerability Disclosure | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-02.4 | D-02.4 Threat-Led Penetration Testing | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-03.1 | D-03.1 Identity Lifecycle Management | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-03.2 | D-03.2 Multi-Factor Authentication | — | — | 0 | NOT_ADDRESSED | — |
| D-03.3 | D-03.3 Authorisation & Least Privilege | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-03.4 | D-03.4 Secure System Defaults | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-04.1 | D-04.1 Incident Detection & Triage | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-04.2 | D-04.2 Incident Containment & Response | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-04.3 | D-04.3 Incident Notification & Reporting | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-04.4 | D-04.4 Incident Recovery & Lessons Learned | — | ✅ GDPR | 1 | PARTIAL | 2.0 |
| D-05.1 | D-05.1 Data Minimisation | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-05.2 | D-05.2 Retention & Archiving | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-05.3 | D-05.3 Right to Erasure | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-05.4 | D-05.4 Data Portability | — | ✅ GDPR | 1 | PARTIAL | 2.0 |
| D-06.1 | D-06.1 Vendor Risk Assessment | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-06.2 | D-06.2 Software Bill of Materials (SBOM) | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-06.3 | D-06.3 Contractual Security Obligations | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-06.4 | D-06.4 Third-Party Boundary Management | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-07.1 | D-07.1 Secure-by-Design Principles | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-07.2 | D-07.2 Secure Coding Practices | — | — | 0 | NOT_ADDRESSED | — |
| D-07.3 | D-07.3 CI/CD Pipeline Security | — | — | 0 | NOT_ADDRESSED | — |
| D-07.4 | D-07.4 Change Management | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-08.1 | D-08.1 General Security Awareness | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-08.2 | D-08.2 Role-Specific Competence | — | — | 0 | NOT_ADDRESSED | — |
| D-08.3 | D-08.3 Management Board Training | — | — | 0 | NOT_ADDRESSED | — |
| D-09.1 | D-09.1 Information Security Policies | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-09.2 | D-09.2 Impact & Risk Assessments | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-09.3 | D-09.3 Asset Inventories | — | — | 0 | NOT_ADDRESSED | — |
| D-09.4 | D-09.4 Records of Processing | ✅ CRA | ✅ GDPR | 2 | SUBSTANTIVE | 2.0 |
| D-10.1 | D-10.1 Continuous Security Monitoring | ✅ CRA | — | 1 | PARTIAL | 2.0 |
| D-10.2 | D-10.2 Audit Logging & Traceability | — | — | 0 | NOT_ADDRESSED | — |
| D-10.3 | D-10.3 Compliance Testing | — | — | 0 | NOT_ADDRESSED | — |
...
- Substantive coverage (≥ 2 regs): **19** (50.0%)
- Partial coverage (1 reg): **11** (28.9%)
- Not addressed (0 regs): **0** (0.0%)
- Mean normative intensity: **2.00**
- Sole-authority gaps: **0**
- Total clause mappings: **612**

## 5. COMPLEMENTARITY

Cross-regulation overlaps are presented below. Section 5.1 expands each overlap into a table of shared sub-domains with the specific clauses that drive the overlap. Section 5.2 captures compound-event scenarios detected by the REDUCE-LLM P1C-LLM-02 stage, in which a single factual incident simultaneously triggers incompatible obligations from multiple regulations.
...
_No synergy opportunities to surface._


### 5.2 Compound Events (LLM-02)

Cross-domain factual events that simultaneously trigger incompatible obligations from multiple regulations. Detected by REDUCE-LLM P1C-LLM-02 against the Regulatory Baseline ``event_templates.yaml`` catalog. Resolution design lives in Phase 2B and is not produced here.

> **[PENDING REVIEW — REDUCE synthesis not yet computed]**
> Section ID: `doc_07.section_5_2.compound_events`
> 
> This section requires P1C-LLM-02 (compound event detection). Re-run the pipeline with a real LLM configured (`MOCK_LLM=false` and Ollama running) to populate this section. Or check the run-phase-1c-reduce logs for failure details.
...
The compliance matrix reveals a meaningful complementarity between the DPO function (resourced at 0.2 FTE) and the Engineering function (5–10 FTE) in addressing **SI-001 (CRA + GDPR → D-01, HIGH)** and **SI-003 (CRA + GDPR → D-09.2, MEDIUM)**, where encryption-at-rest and encryption-in-transit capabilities (CAP-D01-001/002) assign delivery accountability to Engineering while the DPO provides regulatory interpretation—yet both still require a CISO-responsibility layer that is currently unassigned. A structural gap of higher severity emerges for **SI-002 (CRA + GDPR → D-04.3, HIGH)** and **SI-004 (CRA → D-06.2, HIGH)**: the Governance and CISO functions are named as accountable or responsible parties for notification, regulator liaison, and forensic evidence capture (CAP-D04-003, CAP-D04-005), and the Operations function carries retention, deletion, and evidence obligations (CAP-D01-004), none of which hold any designated resourcing in the present structure. **SI-005 (CRA → D-02.3, MEDIUM)** compounds the exposure by introducing an additional CRA-driven domain that presupposes the same unassigned Governance and CISO functions. Time-to-compliance is therefore constrained not by technical delivery capacity—Engineering can implement CAP-D01-001/002 within standard engineering cycles—but by the organizational gap: until CISO, Governance, and Operations are formally constituted as resourced functions, the three HIGH-severity implications (SI-001, SI-002, SI-004) cannot be operationally closed, and the two MEDIUM-severity items (SI-003, SI-005) remain at risk of regulatory escalation.

### 6.2 Strategic Implications (LLM-03)

Cross-lane implications that emerge ONLY when viewing multiple sub-domains together. Pattern detection across architecture, ownership, evidence, and supplier boundaries. Doc 07b (Track B) is the authoritative constraint; this section does NOT propose controls or change tier assignments.

> **[PENDING REVIEW — REDUCE synthesis not yet computed]**
> Section ID: `doc_07.section_6_2.strategic_implications`
> 
> This section requires P1C-LLM-03 (strategic synthesis). Re-run the pipeline with a real LLM configured (`MOCK_LLM=false` and Ollama running) to populate this section.
...
_No gaps detected — every cell has either a clause mapping or an explicit non-applicability record._
...
| --- | --- | --- | --- |
| 1 | Company context loaded (04) | PASS | company_name = - |
| 2 | Sub-domain catalogue present | FAIL | 0 active sub-domains |
| 3 | Clause mappings rendered | PASS | 612 clauses in 06 |
| 4 | Coverage matrix computed | FAIL | 0 sub-domains in ontology |
| 5 | Proportionality computed (07b) | FAIL | see AEGIS-P1-07b |
| 6 | Applicability assessments recorded (05) | FAIL | 0 assessments |
| 7 | Compound events computed (LLM-02) | FAIL | REDUCE-LLM: P1C-LLM-02 run; see §5.2 |
| 8 | Strategic synthesis computed (LLM-03) | FAIL | REDUCE-LLM: P1C-LLM-03 run; see §6.2 |
