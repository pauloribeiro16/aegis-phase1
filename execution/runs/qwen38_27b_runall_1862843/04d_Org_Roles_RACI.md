...
version: 1.0
status: DRAFT
generated_at: "2026-09-01T14:37:34Z"
phase: 1
created: "2026-09-01T14:37:34Z"
updated: "2026-09-01T14:37:34Z"
author: Executor
...
Functional roles are listed below. {'dpo': 'voluntary (GDPR Art. 37(4))', 'ciso': 'combined with CIO', 'cro': 'informal (CEO + CTO)'}. Backup assignments are documented for incident-trigger continuity.

| Role | Person / Team | Reports To | FTE Allocation | Backup |
| --- | --- | --- | --- | --- |
| CEO (also DPO) | Founder | Board | 0.2 DPO + 0.8 CEO (combined 1.0) | CTO (acting DPO) |
| CTO | Founder | Board | 1.0 | CEO (acting CTO) |
| Engineering Team | Engineers | CTO | 5-10 | CTO |
| Customer Support | Support Lead | CEO | 0.5 | CEO |

## 5. Reporting Lines



For MICRO tier the reporting structure is flat:
...
```
        ...
        │                │                 │
   ┌────▼─────┐    ┌─────▼─────┐    ┌─────▼──────┐
   │ Engineer │    │  Founder  │    │ External   │
   │ (ops)    │    │   DPO     │    │ Advisor    │
   └──────────┘    └───────────┘    └────────────┘
```

There is no dedicated CISO. Security and privacy responsibilities
rest with the founder; an external advisor may be engaged on
demand per GDPR Art. 37(2).


**Plain-text description:**

TinyTask Lda., an eight-employee MICRO-tier organisation, is directed by a two-person Board of founders to whom the DPO function and the Engineering function each report directly. The DPO function, allocated 0.2 FTE within a combined 1.0-FTE executive seat, retains ultimate accountability for the technical and organisational security-of-processing measures mandated by GDPR Article 32 and for ensuring the CRA Annex I Part I §1(2) essential requirements are met, while the Operations function (0.5 FTE customer-support line) reports into this same seat and executes data-retention, deletion, and forensic-evidence-capture tasks under CISO and Governance oversight. The Engineering function holds a 1.0-FTE leadership role and a five-person delivery team, serving as the acting party for encryption at rest and in transit. Because the MICRO model does not provide dedicated CISO or Governance staffing, those supervisory responsibilities are absorbed by the DPO and Engineering functions respectively, with the Board retaining final authority over regulator notification and liaison.

## 6. Capability Summary

These capabilities are required by the applicable regulatory perimeter. RACI per individual is intentionally out of scope; capability-to-person allocation is the company's responsibility (see Phase 2B). Functions listed below are drawn from the canonical vocabulary ``['CISO', 'DPO', 'Engineering', 'Governance', 'Operations']``.


### D-01 Capability Summary — Data Protection

| ID | Accountable Function | Regulation Anchor |
| --- | --- | --- |
| CAP-D01-001 | Engineering | GDPR Art.32(1)(a); DORA Art.9 |
| CAP-D01-002 | Engineering | GDPR Art.32(1)(a) |
| CAP-D01-003 | CISO | DORA Art.9 |
| CAP-D01-004 | Operations | GDPR Art.5(1)(e); DORA Art.7 |
Full detail: `data/capabilities/D-01.yaml`



### D-02 Capability Summary — Vulnerability Management

_(Capability catalog for D-02 not yet authored; see data/capabilities/D-02.yaml.)_



### D-03 Capability Summary — Access Control

_(Capability catalog for D-03 not yet authored; see data/capabilities/D-03.yaml.)_



### D-04 Capability Summary — Incident Response

| ID | Accountable Function | Regulation Anchor |
| --- | --- | --- |
| CAP-D04-001 | Operations | NIS2 Art.21(2)(e); DORA Art.17 |
| CAP-D04-002 | CISO | NIS2 Art.21(2)(f); DORA Art.19 |
| CAP-D04-003 | Governance | GDPR Art.33; NIS2 Art.23; DORA Art.19(4) |
| CAP-D04-004 | Operations | DORA Art.12, Art.13 |
| CAP-D04-005 | Operations | GDPR Art.5(1)(f) |
Full detail: `data/capabilities/D-04.yaml`



### D-05 Capability Summary — Data Lifecycle

_(Capability catalog for D-05 not yet authored; see data/capabilities/D-05.yaml.)_



### D-06 Capability Summary — Supply Chain

_(Capability catalog for D-06 not yet authored; see data/capabilities/D-06.yaml.)_



### D-07 Capability Summary — Secure Development

_(Capability catalog for D-07 not yet authored; see data/capabilities/D-07.yaml.)_



### D-08 Capability Summary — Human Factors

_(Capability catalog for D-08 not yet authored; see data/capabilities/D-08.yaml.)_



### D-09 Capability Summary — Governance

_(Capability catalog for D-09 not yet authored; see data/capabilities/D-09.yaml.)_



### D-10 Capability Summary — Monitoring & Audit

_(Capability catalog for D-10 not yet authored; see data/capabilities/D-10.yaml.)_
...
| Board (2 founders) | D-08.3 — ACTIVE | NOT STARTED | 2026-12-31 (target) | D-08.3 |
...
| D-08.3 Management Board Training | ACTIVE | — | — |
...
For TinyTask Lda., routine security events are first identified and triaged by Engineering, then escalated to the CISO for risk assessment and remediation oversight, with Operations supporting containment actions. Where an event constitutes a personal-data breach, the CISO coordinates with Engineering to scope the incident and forwards a structured report to the DPO, who evaluates notifiability obligations under GDPR Article 33. The DPO, in concert with Governance, then initiates the supervisory-authority notification within the 72-hour window mandated by GDPR Article 33 and, where applicable, issues the CRA early-warning within 24 hours as required by CRA Annex I Part II (8)(f). Escalation to the Board via Governance is triggered by any confirmed governance breach, active regulatory action, or material loss of customer trust, at which point Governance assumes the Accountable role for regulator liaison under CAP-D04-003 and directs Operations to preserve forensic evidence in line with CAP-D04-005.
...
**Gate Status:** PASS (proportionate for MICRO tier under P2).

## N-1. Version History

| Version | Date | Author | Changes |
| --- | --- | --- | --- |
| 1.0 | 2026-09-01 | Executor | Generated RACI from state.regulations and a deterministic per-domain mapping |
| 2.0 | 2026-07-29 | Executor (CORR-073) | Scaled §2/§3 to company profile; tier-aware role model + reporting-lines template. |
| 2.3 | 2026-07-29 | Executor (CORR-075) | Remove RACI per individual; replace §6 with Capability Summary sourced from data/capabilities/. No person names referencing roles. |

## N. Document Approval

| Role | Name | Signature | Date |
| --- | --- | --- | --- |
| Document Author | Executor (CORR-075) |  | 2026-09-01 |
