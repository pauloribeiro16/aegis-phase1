...
**Proportionality note (P2 — Company Reality First):** TinyTask Lda. is a micro-SaaS with 8 employees. Inventory is limited to the third parties that actually touch personal data or the production system. No formal supplier programme exists; the inventory is a precondition to building one, not evidence one already exists.

## 2. Inherited Infrastructure

_No cloud services recorded in the architecture inventory._
...
_No providers recorded; contractual controls not yet mapped._

## 5. Supply Chain Risk Assessment

_No cloud services recorded._

## 6. Compliance Mapping (Layer 0)

Active scope = 38 of 38 sub-domains for applicable_regs = [CRA, GDPR]. The four rows below cover the D-06 (Supply Chain) sub-domains within that active set.
...
| --- | --- | --- |
| All cloud providers documented with DPA status | PARTIAL | Section 2: 0 rows |
| Overlap-implied third parties identified | PASS | Section 3 from ontology.overlaps |
| Contractual coverage matrix populated | PARTIAL | Section 4 |
| Risk classification table populated | PARTIAL | Section 5 |
...
| --- | --- | --- | --- |
| 1.0 | 2026-09-01 | Executor | Generated from state[architecture_inventory].cloud_services and ontology.overlaps |
