...
| Scale | MICRO | AEGIS-P1-04 §2 |
| Employees | 8 | AEGIS-P1-04 §2 |
| Revenue | 2000000.0 | AEGIS-P1-04 §2 |
| Applicable regulations | CRA, GDPR | AEGIS-P1-05 §2 |
| Complexity tier | LOW | AEGIS-P1-04 §5 |
| Security FTE | 0.85 | AEGIS-P1-04 §5 + critical analysis |
| Tech stack | AWS, Firebase, GitHub Actions | AEGIS-P1-04 §7 |
...
| LIGHTWEIGHT | 0 | MICRO + BUILD_REQUIRED + MUST (§5.1 row MICRO col BUILD_REQUIRED) |
...
- Excluded sub-domains (sole authority N/A): **0**
...
_No rows produced a narrative in any tier._
...
| --- | --- | --- | --- |
| (a) | A tier is assigned to every ACTIVE sub-domain | FAIL | 0 rows in §4; 0 EXCLUDED in §4 |
...
| (c) | Each row's tier is consistent with the §3 decision table for (S, I, P) | PASS | scale=MICRO, fte=0.85, decision-table applied |
...
| Total rows | §4 row count matches catalogue expectation (0) | FAIL | expected_count=0 |
