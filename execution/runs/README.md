...
| `nemotron3_5_30b_scout_full_1869099` | nemotron 3.5 30B | 1869099 | scout-full ❌ | **tag errada**: submeti `nemotron3.5:30b`, mas a tag em cache é `nemotron-3.5-lightning:30b` | — (cancelado a 14:18) |
| `granite4_2_30b_scout_full_1869100` | granite 4.2 30B | 1869100 | scout-full ⏳ | em curso (tag certa, cache confirmado, warm-up a 14:18) | — |
| `ornith-1_5_9b_scout_full_1869101` | ornith 1.5 9B | 1869101 | scout-full ❌ | **tag errada**: submeti `ornith-1.5:9b`, mas a tag em cache é `ornith:9b` | — (cancelado a 14:18) |
| `nemotron_lightning_30b_scout_full_1869115` | nemotron 3.5 30B | 1869115 | scout-full ⏳ | em curso (tag certa, gnx515, 14:24) | — |
| `ornith_9b_scout_full_1869116` | ornith 9B | 1869116 | scout-full ⏳ | em fila (Priority) | — |
